    ...
    public void ListenerCu(Style style){
        ...
        mDatosListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Float ocu_cuajim = Float.valueOf(snapshot.child("ocu_cuajim").getValue().toString());
